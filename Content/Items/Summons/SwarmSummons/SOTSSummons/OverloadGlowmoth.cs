...
namespace SecretsOfTheSouls.Content.Items.Summons.SwarmSummons.SOTSSummons
{
    ...
    public class OverloadGlowmoth : SwarmSummonBase
    {
        ...
        public OverloadGlowmoth() : base(ModContent.NPCType<Glowmoth>(), nameof(OverloadGlowmoth), 50, ModContent.ItemType<SuspiciousLookingCandle>())
        {
        }
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<SuspiciousLookingCandle>())
